...
CREATE TABLE IF NOT EXISTS friendship (
	id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
	sender INTEGER NOT NULL REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE,
	reciever INTEGER NOT NULL REFERENCES users(user_id) ON DELETE CASCADE ON UPDATE CASCADE,
